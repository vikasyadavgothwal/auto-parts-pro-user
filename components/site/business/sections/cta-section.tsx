        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <BusinessDemoDialogButton
              ...
              className="h-auto rounded-xl bg-white px-8 py-4 text-lg font-medium text-primary hover:bg-gray-100"
            >
              Schedule a Demo
            </BusinessDemoDialogButton>
            <BusinessDemoDialogButton
              ...
              variant="outline"
              className="h-auto rounded-xl border-2 border-white bg-transparent px-8 py-4 text-lg font-medium text-white hover:bg-white/10 hover:text-white"
            >
              Contact Sales
            </BusinessDemoDialogButton>
          </div>
