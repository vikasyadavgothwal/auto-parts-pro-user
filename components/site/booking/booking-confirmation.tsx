        ...
        <Card className="rounded-3xl border border-border bg-card shadow-none">
          <CardContent className="p-12 text-center">
            ...
            <div className="flex flex-col justify-center gap-4 sm:flex-row">
              <Button
                asChild
                className="rounded-xl bg-primary px-8 py-6 text-primary-foreground hover:bg-brand-primary-hover"
              >
              ...
              <Button
                ...
                className="rounded-xl border-2 border-border bg-card px-8 py-6 text-foreground hover:border-primary hover:bg-card"
              >
                Book Another
              </Button>
            </div>
