                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <label className="group flex cursor-pointer items-center gap-3">
                      <Input
                        type="checkbox"
                        className="w-4 h-4 rounded border-[#2A2A2A] bg-[#0A0A0A] text-[#DC2626] focus:ring-[#DC2626]/20"
                        data-fg-cw0b45="135.196:135.11403:/src/app/pages/search.tsx:175:23:6640:122:e:input"
                        data-fgid-cw0b45=":r9k:"
                      />
                      <div className="flex flex-1 items-center gap-2">
